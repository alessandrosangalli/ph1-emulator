  ...
  public execute = (): OutputDataInterface => {
    ...
    while (true) {
      if (this.inputData[this.programCounter].value === this.hexToNumber('00')) {
        ...
        outputData.push({ operator: 'LDR', value: this.inputData[this.programCounter].value, comment: `; AC <- MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
        ...
        outputData.push({ operator: 'STR', value: this.inputData[this.programCounter].value, comment: `; MEM[${this.numberToHex(this.inputData[this.programCounter].value)}] <- STR` })
      } else if (this.inputData[this.programCounter].value === this.hexToNumber('30')) {
        this.programCounter++
        this.accumulator += this.inputData[this.inputData[this.programCounter].value].value
        outputData.push({ operator: 'ADD', value: this.inputData[this.programCounter].value, comment: `; AC <- AC + MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
      } else if (this.inputData[this.programCounter].value === this.hexToNumber('40')) {
        this.programCounter++
        this.accumulator -= this.inputData[this.inputData[this.programCounter].value].value
        outputData.push({ operator: 'SUB', value: this.inputData[this.programCounter].value, comment: `; AC <- AC - MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
      } else if (this.inputData[this.programCounter].value === this.hexToNumber('50')) {
        this.programCounter++
        this.accumulator *= this.inputData[this.inputData[this.programCounter].value].value
        outputData.push({ operator: 'MUL', value: this.inputData[this.programCounter].value, comment: `; AC <- AC * MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
      } else if (this.inputData[this.programCounter].value === this.hexToNumber('60')) {
        this.programCounter++
        this.accumulator /= this.inputData[this.inputData[this.programCounter].value].value
        outputData.push({ operator: 'DIV', value: this.inputData[this.programCounter].value, comment: `; AC <- AC / MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
        ...
        outputData.push({ operator: 'AND', value: this.inputData[this.programCounter].value, comment: `; AC <- AC & MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
      } else if (this.inputData[this.programCounter].value === this.hexToNumber('90')) {
        this.programCounter++
        this.accumulator = (this.accumulator | this.inputData[this.inputData[this.programCounter].value].value)
        outputData.push({ operator: 'OR', value: this.inputData[this.programCounter].value, comment: `; AC <- AC | MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
      } else if (this.inputData[this.programCounter].value === this.hexToNumber('a0')) {
        this.programCounter++
        this.accumulator = (this.accumulator ^ this.inputData[this.inputData[this.programCounter].value].value)
        outputData.push({ operator: 'XOR', value: this.inputData[this.programCounter].value, comment: `; AC <- AC ^ MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
        ...
        outputData.push({ operator: 'JMP', value: this.inputData[this.programCounter].value, comment: `; PC <- MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
        continue
      } else if (this.inputData[this.programCounter].value === this.hexToNumber('c0')) {
        this.programCounter++
        outputData.push({ operator: 'JEQ', value: this.inputData[this.programCounter].value, comment: `; PC <- MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
        ...
        this.programCounter++
        outputData.push({ operator: 'JG', value: this.inputData[this.programCounter].value, comment: `; PC <- MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
        ...
        this.programCounter++
        outputData.push({ operator: 'JL', value: this.inputData[this.programCounter].value, comment: `; PC <- MEM[${this.numberToHex(this.inputData[this.programCounter].value)}]` })
